...
const en = {
  ...
  home: {
    ...
    featuresTitle: "Everything Friday can do, with runtime status upfront.",
    howEyebrow: "How it works",
    howTitle: "Configure once. Run from chat, schedules, channels, or subagents.",
    connectorsEyebrow: "Connectors",
    connectorsTitle: "Connect Google today. Extend the rest through MCP and plugins.",
    channelsEyebrow: "Channels",
    channelsTitle: "Reach teams through Telegram now, with more channels ready to wire in.",
    channelsPanelTitle: "One catalog, clear runtime states.",
    ...
    operatorsTitle: "Dedicated operators for agents, voice, media, schedules, and background work.",
    providersEyebrow: "AI Providers",
    providersTitle: "Choose the right model provider for each job.",
    faqEyebrow: "FAQ",
    faqTitle: "Answers before you install.",
    downloadTitle: "Bring Friday to your desktop.",
...
const it = {
  ...
  home: {
    ...
    featuresTitle: "Tutto cio che Friday puo fare, con stato runtime in evidenza.",
    howEyebrow: "Come funziona",
    howTitle: "Configura una volta. Avvia da chat, pianificazioni, canali o subagent.",
    connectorsEyebrow: "Connettori",
    connectorsTitle: "Collega Google oggi. Estendi il resto con MCP e plugin.",
    channelsEyebrow: "Canali",
    channelsTitle: "Raggiungi i team con Telegram ora, con altri canali pronti da collegare.",
    channelsPanelTitle: "Un catalogo, stati runtime chiari.",
    channelsPanelDescription:
    ...
    operatorsTitle: "Operatori dedicati per agenti, voce, media, pianificazioni e lavoro in background.",
    providersEyebrow: "Provider AI",
    providersTitle: "Scegli il provider modello giusto per ogni lavoro.",
    faqEyebrow: "FAQ",
    faqTitle: "Risposte prima dell'installazione.",
    downloadTitle: "Porta Friday sul tuo desktop.",

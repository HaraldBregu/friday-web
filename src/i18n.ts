...
const it = {
  ...
  integrationsPage: {
    title: "Integrazioni",
    description: "Scopri i provider, i canali, i server MCP e le automazioni che puoi collegare a Friday.",
    eyebrow: "Integrazioni",
    heading: "Collega Friday agli strumenti che usi ogni giorno.",
    intro: "Scegli provider AI, canali, server MCP e automazioni. Friday li riunisce in un unico spazio di lavoro.",
    singular: "integrazione",
    plural: "integrazioni",
    ctaEyebrow: "Ti serve altro?",
    ctaTitle: "Collega a Friday gli strumenti del tuo team.",
    ctaDescription:
      "Parti dalle integrazioni disponibili oppure crea una skill o un server MCP per il tuo flusso di lavoro.",
  },
  communityPage: {
    title: "Community",
    description: "Scopri come seguire lo sviluppo di Friday, proporre miglioramenti e condividere flussi di lavoro con la community.",
    eyebrow: "Community",
    heading: "Costruiamo insieme un assistente più utile e trasparente.",
    intro: "Friday cresce grazie a persone che condividono idee, documentazione e flussi di lavoro reali.",
    cards: [
      {
        icon: "Users",
        title: "Parte dai problemi reali",
        description:
          "Friday deve adattarsi al modo in cui persone e team lavorano davvero, comprese approvazioni, contesto incompleto e regole che cambiano.",
      },
      {
        icon: "BookOpen",
  ...
  operatorsPage: {
    title: "Operatori",
    description:
      "Scopri le funzioni di Friday per chat, strumenti, voce, immagini, skill, MCP, canali, pianificazioni e memoria.",
    eyebrow: "Operatori",
    ...
    ctaDescription:
      "Configura provider e modello nelle Impostazioni. Friday conserva le credenziali sul tuo computer e usa la scelta corretta quando serve.",
  },
  notFoundPage: {

...
const en = {
  ...
  productMockup: {
    ...
    scheduledValue: "Daily 9:00 status brief",
    channelLabel: "Channel",
    channelValue: "Telegram paired, Slack ready",
    privacyLabel: "Privacy",
    privacyValue: "Keys and history stay local",
...
const it = {
  ...
  productMockup: {
    ...
    scheduledValue: "Brief giornaliero alle 9:00",
    channelLabel: "Canale",
    channelValue: "Telegram abbinato, Slack pronto",
    privacyLabel: "Privacy",
    privacyValue: "Chiavi e cronologia restano locali",

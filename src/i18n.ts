...
const en = {
  ...
  home: {
    ...
    featuresTitle: "Core capabilities, clearly marked.",
    ...
    operatorsTitle: "Agents, voice, media, and automation.",
    providersEyebrow: "AI Providers",
    providersTitle: "Pick the model for the job.",
    faqEyebrow: "FAQ",
...
const it = {
  ...
  home: {
    ...
    featuresTitle: "Capacita principali, stato chiaro.",
    ...
    operatorsTitle: "Agenti, voce, media e automazione.",
    providersEyebrow: "Provider AI",
    providersTitle: "Scegli il modello per il lavoro.",
    faqEyebrow: "FAQ",
    faqTitle: "Cosa sapere prima.",

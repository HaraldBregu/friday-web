...
const en = {
  ...
  productMockup: {
    ...
    interactiveReply:
      "I can do that. I will keep it short, use the local context already visible here, and ask before taking any action.",
...
const it = {
  ...
  productMockup: {
    ...
    interactiveReply:
      "Posso farlo. Lo terro breve, usero il contesto locale gia visibile qui e chiedero prima di eseguire qualsiasi azione.",

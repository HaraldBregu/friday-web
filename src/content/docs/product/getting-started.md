...
description: "Install Friday, add provider keys, choose models, and start chatting."
category: "Product"
...
Friday supports Windows, macOS on Intel and Apple Silicon, and Linux.

The interface supports English and Italian, light, dark, and system themes, a command menu, and optional menu-bar or tray presence.
